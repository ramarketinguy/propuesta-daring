...
- [x] Conectar la API de conversiones (CAPI) de Meta: token guardado como secreto + evento de prueba aceptado por Meta (05-sep-2026). Resta confirmar con primera venta real.
